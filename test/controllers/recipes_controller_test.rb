...
class RecipesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "show" do
    ...
    data = JSON.parse(response.body)
    assert_equal ["id", "title", "ingredients", "prep_time", "cook_time", "total_time", "instructions", "created_at", "updated_at", "image"], data.keys
  end

  test "update" do
    recipe = Recipe.first
    patch "/recipes/#{recipe.id}.json", params: { title: "Updated title", ingredients: "Updated ingredients", prep_time: "Updated prep_time", cook_time: "Updated cook_time", total_time: "Updated total_time", instructions: "Updated instructions", image: "Updated image" }
    assert_response 200
